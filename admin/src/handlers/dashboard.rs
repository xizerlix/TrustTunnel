...
pub struct DashboardTemplate {
    ...
    pub host_cores: u32,
    pub host_ram_total: String,
    pub host_disk_size: String,
...
struct Stats {
    ...
    host_cores: u32,
    host_ram_total: String,
    host_disk_size: String,
    host_load: String,
    host_ram: String,
    host_disk: String,
    host_uptime: String,
...
async fn collect(state: &AppState) -> Stats {
    ...
    Stats {
        ...
        host_ram_total: host.ram_total,
        host_disk_size: host.disk_size,
        host_load: host.load,
        host_ram: host.ram,
        host_disk: host.disk,
...
fn fill_data(stats: Stats, t: I18n) -> DashboardDataTemplate {
    ...
    DashboardDataTemplate {
        ...
        host_ram_total: stats.host_ram_total,
        host_disk_size: stats.host_disk_size,
...
pub async fn dashboard(
    ...
    DashboardTemplate {
        ...
        host_cores: data.host_cores,
        host_ram_total: data.host_ram_total,
        host_disk_size: data.host_disk_size,
