...
pub const EN: I18n = I18n {
    ...
    rules: "Rules",
    rules_help: "First matching rule wins. Empty rows are ignored. Inbound rules need a CIDR and/or a client-random prefix. A domain (e.g. instagram.com) drops CONNECT, TLS SNI, and DNS to that host and its subdomains; it does not change inbound TLS accept.",
    cidr: "CIDR",
...
pub const RU: I18n = I18n {
    ...
    rules: "Правила",
    rules_help: "Срабатывает первое совпадение. Пустые строки игнорируются. Входящим правилам нужен CIDR и/или префикс client random. Домен (например instagram.com) рвёт CONNECT, TLS SNI и DNS на этот хост и поддомены; входящий TLS accept не меняется.",
    cidr: "CIDR",
